...
| 9 | #9 | Replace scaffold navigation with mobile-first app entry and usability polish | Remove the scaffold home, add smart `/` entry and current-week assurance, use compact Today/Week/Review navigation, quiet Sign out, tighter screen context, and current Week mobile positioning at today. | Open |
