...
| 11 | #45 | Fix week grid headers, same-day correction, nav state, and edit-list gaps | Post-MVP usability follow-up: sticky Week/Review day headers, limited today-column correction in Week, Today `Unskip`, single-active nav state, category-local `+ Add activity`, and bottom `+ Add category`. | Open |
...
- Week and Review grids share responsive sizing and sticky day headers; keep
  their scroll/snap behavior aligned when changing either grid.
