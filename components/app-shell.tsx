...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-[100dvh] flex-col overflow-hidden sm:block sm:h-auto sm:min-h-screen sm:overflow-visible">
      ...
      <main className="mx-auto min-h-0 w-full max-w-6xl flex-1 overflow-y-auto overscroll-y-contain px-2 pb-4 pt-3 sm:overflow-visible sm:overscroll-auto sm:px-6 sm:pb-8 sm:pt-6 lg:px-8">
        {children}
      </main>

      <nav
        aria-label="Main navigation"
        className="relative z-40 shrink-0 border-t border-stone-200 bg-paper/95 px-3 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 shadow-[0_-8px_24px_rgba(47,48,43,0.08)] backdrop-blur sm:hidden"
      >
