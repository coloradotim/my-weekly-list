...
import { WeekPreviewClient } from "./week-preview-client";

export const dynamic = "force-dynamic";

export default function DevWeekPreviewPage() {
  if (!isDevWeekPreviewEnabled()) {
    notFound();
  }

  return (
    <main className="mx-auto w-full max-w-6xl px-2 py-3 sm:px-6 sm:py-6">
