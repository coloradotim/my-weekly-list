...
export default async function DevReviewPreviewPage({
  searchParams,
}: {
  ...
  const initialScenario = params?.scenario === "sunday" ? "sunday" : "past";
  const initialDetailsOpen = params?.details === "open";
